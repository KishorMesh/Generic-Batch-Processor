using Akka.Actor;
using Akka.Event;
using Executer.Shared;
using System;
using TaskExecuter.Shared.Exceptions;
using TaskExecuter.Shared.ExternalSystems;
...
namespace TaskExecuter.Shared.Actors
{
    public class WorkerActor: ReceiveActor
    {
        ...
        private void HandleJobExecute(JobStartedMessage job)
        {
           ...
           // ColorConsole.WriteLineCyan("Task {0} is processing by executer...", job.ID);
